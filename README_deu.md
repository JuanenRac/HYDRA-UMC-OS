...
| --- | --- |
| [HYDRA-UMC-SDK](https://github.com/JuanenRac/HYDRA-UMC-SDK) | Versionierte Verträge, Thin Clients und Konformitäts-Fixtures, die vom Geräteagenten verwendet werden. |

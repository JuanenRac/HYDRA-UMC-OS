...
ADMIN_USER="${HYDRA_UMC_ADMIN_USER:-hydra_umc}"
SERVICE_USER="hydra-umc"
...
run install -d -o "$SERVICE_USER" -g "$SERVICE_USER" /etc/hydra-umc /var/lib/hydra-umc /opt/hydra-umc
